...
namespace VRTK.GrabAttachMechanics
{
    ...
    public class VRTK_ChildOfControllerGrabAttach : VRTK_BaseGrabAttach
    {
        ...
        {
            if (grabbedSnapHandle == null || grabbedSnapHandle == obj.transform)
            {
                //新增 如果没有指定snapHandle，也适配方向
            ...
            else
            {
                ...
                obj.transform.rotation = controllerAttachPoint.transform.rotation * Quaternion.Inverse(grabbedSnapHandle.transform.rotation) * obj.transform.rotation;
